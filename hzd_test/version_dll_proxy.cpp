...
typedef DWORD(WINAPI* GetFileVersionInfoA_ptr)(LPCSTR lptstrFilename, DWORD dwHandle, DWORD dwLen, LPVOID lpData);
...
extern "C" DWORD APIENTRY GetFileVersionInfoSizeA(LPCSTR lptstrFilename, LPDWORD lpdwHandle)
{
...
extern "C" void __stdcall GetFileVersionInfoByHandle() { GetFileVersionInfoByHandle_Orig(); }
